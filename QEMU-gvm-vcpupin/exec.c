...
static void *(*phys_mem_alloc)(size_t size, uint64_t *align, int phys_node) =
                               qemu_anon_ram_alloc;
 ...
 */
void phys_mem_set_alloc(void *(*alloc)(size_t, uint64_t *align, int phys_node))
{
